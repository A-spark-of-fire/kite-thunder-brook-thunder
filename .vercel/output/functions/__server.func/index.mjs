...
var grokOgIdentity = { "site": {
	"title": "SUPEYO",
	"description": "Order SUPEYO packaged drinking water for home and office delivery in Nadia.",
	"type": "website",
	"card": "custom",
	"color": "0B3D91",
	"image": "/og.jpg"
...
var _lazy_yN3buh = defineLazyEventHandler(() => import("./_chunks/ssr-renderer.mjs"));
var findRoute = /* @__PURE__ */ (() => {
	const data = {
		route: "/**",
		handler: _lazy_yN3buh
	};
	return ((_m, p) => {
		return {
			data,
