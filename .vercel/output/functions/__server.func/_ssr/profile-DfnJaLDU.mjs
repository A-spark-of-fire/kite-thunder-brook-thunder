...
//#region node_modules/.nitro/vite/services/ssr/assets/profile-DfnJaLDU.js
...
var getMe = createServerFn({ method: "GET" }).middleware([authMiddleware]).handler(getMe_createServerFn_handler, async ({ context }) => {
	...
	const unread = await sql`select count(*)::int as n from notifications where user_id = ${context.userId} and is_read = false`;
	return {
		profile,
...
//#endregion
export { claimAdminDesk_createServerFn_handler, getMe_createServerFn_handler, listMyNotifications_createServerFn_handler, markNotificationsRead_createServerFn_handler, requestPasswordReset_createServerFn_handler, saveMyAddress_createServerFn_handler, submitContact_createServerFn_handler, updateMyProfile_createServerFn_handler };
